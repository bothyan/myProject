  ...
  <div>
      ...
      <div class="con1">
        <div class="left">
          <div class="box box1" id="dash-box1" _index="1">
            ...
            <img src="../../../static/images/line2.png" />
          </div>
          ...
          <div class="box box4" id="dash-box4" _index="4">
            ...
            <p class="num timer" data-speed="1000" data-from="0" data-to="">0</p>
            <p class="tips">当月总数</p>
            <img src="../../../static/images/line1.png" />
          </div>
        </div>
      ...
      <div class="con2">
        ...
        <div class="right">
          ...
          <div class="box10">
            ...
            <a class="send" href="mailto:mail_diaoshaopeng@163.com">发送邮件</a>
          </div>
        </div>
      </div>
    </div>
    <div class="dashpop" id="dashpop">
      ...
      <div class="select-box">
        ...
        <select class="form-control" id="toggle" name="imagetype">
...
<style scoped>
  ...
  .title {
    ...
    height: 55px;
    text-indent: 80px;
    background: #fafafa url(../../../static/images/icon.png) no-repeat 30px center;
    line-height: 55px;
  ...
  .dash-head .li1 {
    background: #e64d43 url(../../../static/images/box1.png) no-repeat center center;
  }
  .dash-head .li2 {
    background: #29bb9c url(../../../static/images/box2.png) no-repeat center center;
  }
  .dash-head .li3 {
    background: #3b99d8 url(../../../static/images/box3.png) no-repeat center center;
  }
  .dash-head .li4 {
    background: #995cb3 url(../../../static/images/box4.png) no-repeat center center;
    margin-right: 0;
  }
  .con1 {
    width: 96%;
  ...
  .con2 .box10 .tips {
    width: 60%;
    padding-left: 25px;
    background: url(../../../static/images/brella.png) no-repeat 0 0;
    margin: 0 auto;
    color: #cbcae1;
    font-size: 15px;
  }
